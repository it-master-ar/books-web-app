...
var bookCreate = document.getElementById('bookCreate');
var booksRefresh = document.getElementById('booksRefresh');

var books = _storage2.default.get('books');
...
booksRefresh.addEventListener('click', function (e) {
  e.preventDefault();

  _api2.default.getBooks().then(function (res) {
    _storage2.default.set('books', res);
    console.log(res);
...
bookCreate.addEventListener('submit', function (e) {
  e.preventDefault();
  ...
  _api2.default.createBook(book).then(function (res) {
